...
export const serviceAreaPages: ServiceAreaPage[] = [
  {
    ...
    intro:
      "High Point Tree Service helps Las Cruces property owners with tree removal, tree trimming, pruning, stump grinding, storm damage cleanup, tree assessments, and property cleanup.",
    overview:
  ...
  },
  {
    ...
    intro:
      "High Point Tree Service helps Ruidoso property owners with tree removal, trimming, pruning, stump grinding, storm damage cleanup, tree assessments, and property cleanup.",
    overview:
  ...
  },
  {
    ...
    intro:
      "High Point Tree Service helps Roswell property owners with tree removal, tree trimming, pruning, stump grinding, storm cleanup, tree assessments, and property cleanup.",
    overview:
  ...
  },
  {
    ...
    intro:
      "High Point Tree Service helps Alamogordo property owners with tree removal, trimming, pruning, stump grinding, storm damage cleanup, tree assessments, and property cleanup.",
    overview:
